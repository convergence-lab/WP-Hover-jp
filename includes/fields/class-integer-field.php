...
/**
 * WP Glossary Hover Integer Field class. This class serves as a integer settings field.
 *
 * @package   WPGH_Integer_Field
 * @author    chorton2227
 */
class WPGH_Integer_Field extends WPGH_Base_Field
{
    ...
    public function __construct($setting_name, $id, $title, $description, $default)
    {
        ...
        parent::__construct($setting_name, $id, $title, WPGH_Field_Types_Enum::Integer, $description, $default);
     ...
     * @since     1.0.0
     * @param     mixed      $value    Value of field.
     * @return    integer    Valid value for settings field or null if invalid
     */
