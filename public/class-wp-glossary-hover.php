...
class WP_Glossary_Hover
{
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_style(WP_Glossary_Hover::PLUGIN_SLUG . '-jquery-ui', plugins_url('../vendor/jquery-ui/css/jquery-ui.min.css', __FILE__), array(WP_Glossary_Hover::PLUGIN_SLUG . '-plugin-styles'), '1.11.4');
        wp_enqueue_style(WP_Glossary_Hover::PLUGIN_SLUG . '-jquery-ui-theme', plugins_url('../vendor/jquery-ui/css/theme/' . $settings['styles_tooltip_theme'] . '/theme.css', __FILE__), array(WP_Glossary_Hover::PLUGIN_SLUG . '-jquery-ui'), '1.11.4');
        ...
        .entry-content a.wpgh-tooltip:focus {
            ...
            border: none;
            border-bottom-style: {$settings['styles_link_underline']};
